class SceneMenu extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('menu', 'assets/menu/menu2.png');
        this.load.image('etoiles', 'assets/menu/etoiles.png');
    }
    ...
    create() {
        ...
        let playbutton = this.add.image(960, 580, 'play').setPipeline('Light2D');

        this.add.image(680, 150, 'titre').setOrigin(0, 0);
